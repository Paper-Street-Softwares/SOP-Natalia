        ...
        <div className="container mx-auto flex items-center m-auto max-w-[1215px] h-full w-[90%] justify-between py-4 phone3:py-6 desktop1:py-6 desktop1:max-h-24">
          ...
          {isMobileMenuOpen && (
            <div className="fixed inset-0 pt-24 px-6 desktop1:hidden z-40 w-full">
              ...
              >
                <div className="flex flex-col gap-6 bg-white max-w-[500px] text-center items-center p-4 text-lg mx-auto font-secondFont font-medium border-l border-r border-b border-primary/20 rounded-md">
                  {labels.map((item, index) => (
                    <Link
                      to={ids[index]}
